<title>Assessment Report | Southview Junior School</title>
      ...
      <div class="container-fluid d-flex align-items-center">
         <div class="row">
            <div class="col-lg-12 col-md-10">
               <h1 class="display-2 text-white" data-aos="slide-right" data-aos-duration="1000">Assessment Report</h1>
               <p class="text-white mt-0 mb-2" data-aos="slide-right" data-aos-duration="1500">You can upload & take a look at how you assessed a student.</p>
                  ...
                  <table class="table align-items-center table-flush table-striped">
                     ...
                     <tbody>
                        <tr>
                           ...
                           <td>
                              <a href="#!" class="font-weight-bold">Most Improved</a>
                           </td>
                        ...
                        <tr>
                           ...
                           <td>
                              <a href="#!" class="font-weight-bold">Best Footballer</a>
                           </td>
                           <td class="table-actions">
                              <a href="#!" class="table-action" data-toggle="modal" data-target="#modal-form">
                              <i class="ni ni-cloud-upload-96"></i>
                        ...
                        <tr>
                           ...
                           <td>
                              <a href="#!" class="font-weight-bold">Top Student</a>
                           </td>
                           <td class="table-actions">
                              <a href="#!" class="table-action" data-toggle="modal" data-target="#modal-form">
                              <i class="ni ni-cloud-upload-96"></i>
                        ...
                        <tr>
                           ...
                           <td>
                              <a href="#!" class="font-weight-bold">Best Runner</a>
                           </td>
                           <td class="table-actions">
                              <a href="#!" class="table-action" data-toggle="modal" data-target="#modal-form">
                              <i class="ni ni-cloud-upload-96"></i>
